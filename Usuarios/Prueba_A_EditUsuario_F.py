...
try:
    ...
    ## Flujo 2: Edición de usuario fallida - Campos vacíos
    try:
        driver.get("http://localhost/proyectoEscuela/admin/usuarios/edit.php?id=43")
        driver.find_element(By.NAME, "nombres").clear()
        driver.find_element(By.NAME, "nombres").send_keys("")
        driver.find_element(By.NAME, "email").clear()
        driver.find_element(By.NAME, "email").send_keys("")
        driver.find_element(By.NAME, "password").clear()
        driver.find_element(By.NAME, "password").send_keys("")
        driver.find_element(By.NAME, "password_repeat").clear()
        driver.find_element(By.NAME, "password_repeat").send_keys("")
        driver.find_element(By.XPATH, "//button[@type='submit']").click()
        time.sleep(10)

        if "edit.php" in driver.current_url:
            print("✅ Flujo 2: Edición de usuarios fallida - PASÓ")
        else:
            print("❌ Flujo 2: Edición de usuarios fallida - FALLÓ")
    except Exception as e:
        print("❌ Flujo 2: Edición de usuarios fallida - FALLÓ:", str(e))
